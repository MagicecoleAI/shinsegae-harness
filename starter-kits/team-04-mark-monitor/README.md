...
2. `samples/input/snapshots/`와 `monitoring-rules.md`를 확인합니다.
3. `/mark-monitor` 또는 자연어로 Source 검사 계획을 요청합니다.
4. 결과를 `outputs/mark-brief.md`에 저장합니다.
